...
<div class="container mt-5">
    ...
    <div class="form-group border border-black bg-dark text-white p-3 rounded-4 btn-group btn-group-lg">
        <button type="button" class="btn btn-outline-danger btn-lg rounded-4 mx-2"><i class="bi bi-lock-fill"></i></button>
        <button type="button" class="btn btn-outline-success btn-lg rounded-4 mx-2"><i class="bi bi-unlock-fill"></i></button>
        <button type="button" class="btn btn-outline-info btn-lg rounded-4 mx-2"><i class="bi bi-search"></i></button>
    </div>
